          ...
          <div class="col-md-8">
            ...
            <form action="{{ route('estudiantes.store') }}" method="POST" enctype="multipart/form-data" id="form-estudiante">
              ...
              <div class="mb-4 row align-items-center">
                ...
                <div class="col-sm-9">
                  <select id="rol" name="rol" class="form-select fs-5" required>
              ...
              <div id="campos-comunes" style="display:none;">
                <div class="mb-4 row align-items-center">
                  ...
                  <div class="col-sm-9">
                    <input type="text" id="nombre" name="nombre" class="form-control fs-5" placeholder="Ingrese nombre completo">
                  </div>
                </div>
                ...
                <div class="mb-4 row align-items-center">
                  ...
                  <div class="col-sm-9">
                    <input type="text" id="cedula" name="cedula" class="form-control fs-5" placeholder="Ingrese la cédula">
                  </div>
                </div>
              </div>
              ...
              <div id="campo-correo" style="display:none;" class="mb-4 row align-items-center">
                ...
                <div class="col-sm-9">
                  <input type="email" id="correo" name="correo" class="form-control fs-5" placeholder="Ingrese correo electrónico">
                </div>
              </div>
              ...
              <div id="campos-estudiante" style="display:none;">
                <div class="mb-4 row align-items-center">
                  ...
                  <div class="col-sm-9">
                    <input type="text" id="seccion" name="seccion" class="form-control fs-5" placeholder="Ingrese la sección">
                  </div>
                </div>
                ...
                <div class="mb-4 row align-items-center">
                  ...
                  <div class="col-sm-9">
                    <input type="text" id="especialidad" name="especialidad" class="form-control fs-5" placeholder="Ingrese la especialidad">
                  </div>
                </div>
              ...
              <!-- Botones -->
              <div class="d-flex justify-content-end gap-3 mt-4 pe-5 ms-5">
