...
<body>
 <!-- Encabezado -->
      ...
      <div class="row mb-3">
        ...
        <div class="col-md-4">
          ...
          <select id="tipoAsistencia" class="form-select beca-select fs-5">
            ...
            <option value="desayuno_almuerzo">Desayuno - Almuerzo</option>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content text-center">
        ...
        <div class="modal-footer justify-content-center">
          ...
          <button type="button" class="btn btn-primary fs-5" id="confirmarAsistencia">
            Realizar asistencia
          </button>
        </div>
      </div>
  ...
  <script src={{ asset('js/AsistenciaRapida.js') }}></script>
</body>
</html>
